...
minimize obj:
	(u1 * (exp( 2.079442*(u2+(log(8.0))*u3) )) - 8.0)^2 + 
	(u1 * (exp( 2.197225*(u2+(log(9.0))*u3) )) -	8.4305)^2 + 
	(u1 * (exp( 2.302585*(u2+(log(10.0))*u3) )) - 9.5294)^2 + 
	(u1 * (exp( 2.397895*(u2+(log(11.0))*u3) )) - 10.4627)^2 + 
	(u1 * (exp( 2.484907*(u2+(log(12.0))*u3) )) - 12.0)^2 + 
	(u1 * (exp( 2.564949*(u2+(log(13.0))*u3) )) - 13.0205)^2 + 
	(u1 * (exp( 2.639057*(u2+(log(14.0))*u3) )) - 14.5949)^2 + 
	(u1 * (exp( 2.708050*(u2+(log(15.0))*u3) )) - 16.1078)^2 + 
	(u1 * (exp( 2.772589*(u2+(log(16.0))*u3) )) - 18.0596)^2 + 
	(u1 * (exp( 2.890372*(u2+(log(18.0))*u3) )) - 20.4569)^2 + 
	(u1 * (exp( 2.995732*(u2+(log(20.0))*u3) )) - 24.25)^2 + 
	(u1 * (exp( 3.218876*(u2+(log(25.0))*u3) )) - 32.9863)^2;
